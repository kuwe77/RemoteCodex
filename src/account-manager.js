...
const CONFIG_DIR = process.env.REMOTECODEX_CONFIG_DIR
    ? process.env.REMOTECODEX_CONFIG_DIR
    : join(homedir(), '.remotecodex');
...
const CODEX_AUTH_FILE = process.env.REMOTECODEX_CODEX_AUTH_FILE
    ? process.env.REMOTECODEX_CODEX_AUTH_FILE
